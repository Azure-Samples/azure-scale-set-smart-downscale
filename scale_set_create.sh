...
FUNCTION_APP_SETTINGS=$FUNCTION_APP_SETTINGS"LookupTimeInMinutes=$FUNC_PARAM_LOOKUP_TIME_IN_MINUTES "
FUNCTION_APP_SETTINGS=$FUNCTION_APP_SETTINGS"CPUTreshold=$FUNC_PARAM_CPU_TRESHOLD "
